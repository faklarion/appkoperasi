...
<html>
    <head>
        ...
        <title>Login - CV Kemitraan Usaha Bersama</title>
        <link rel="icon" href="<?php echo base_url('assets/images/logo_kub.png')?>" type="image/x-icon">
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <img src="<?php echo base_url('assets/images/logo_kub.png')?>" width="50%" alt="">
            </div>
            <!-- /.login-logo -->
